...
6. **One adapter, many translators.** OATP enforces tool discipline through a single universal adapter. Framework-specific tooling translates registries into the OATP shape; it does not duplicate the enforcement layer.
